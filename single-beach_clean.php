...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>   
	...
	<div class="pagination">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<?php if (get_previous_post_link()) : previous_post_link('%link', '<span class="pagination-text">Prev Beach Clean</span>'); endif; ?>
					<span class="paginate-home bright-blue-color share-trigger">Share</span>
					<?php if (get_next_post_link()) : next_post_link('%link','<span class="pagination-text">Next Beach Clean</span>'); endif; ?>
